            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('admin.receipt') }}">Receipt List</a></li>
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="form-group col-md-3">
                                 ...
                                 <div class="form-group col-md-3">
                                    ...
                                    @if($dataArr->receipt_type == 1)
                                    <p>Credit</p>
                                    @elseif($dataArr->receipt_type == 2)
                                    <p>Debit</p>
                                    @endif
                                </div>
                                <div class="form-group col-md-3">
                            ...
                            <div class="row">
                                <div class="form-group col-md-3">
                                    ...
                                    <p>{{ date('d-m-Y',strtotime($dataArr->receipt_date)) ?? "" }}</p>
                                </div>
                            </div>
                        </div>
                        <!-- /.card-body -->
