            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('admin.vendor') }}">Vendor List</a></li>
                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title">{{ $dataArr['vendor_name'] ?? '' }}</h3>
                        </div>
                        <!-- /.card-header -->
                        <div class="card-body">
                            <div class="row">
                    ...
                    <!-- /.card -->
                        <!--  Bank Account Details -->
                            <div class="card card-info">
                                ...
                                <!-- /.card-header -->
                                <div class="card-body">
                                    <a href="{{ route('admin.vendor.add-bank-details',['vendorId'=>$dataArr->id]) }}" class="btn btn-primary float-right mb-2"> Add Bank Account</a>
                                        ...
                                        <tbody>
                                            <tr>
                                                @forelse ($dataArr->bank_account as $detail )
                                                    ...
                                                    <td><a href="{{route('admin.vendor.edit-bank-details',['vendorId'=>$detail->vendor_id,'id'=>$detail->id])}}" class="edit btn btn-primary  mx-1 btn-sm"><i class="fa fa-edit"></i></a>
                                                        <a href="{{route('admin.vendor.delete-bank-details',['vendorId'=>$detail->vendor_id,'id'=>$detail->id])}}" class="edit btn btn-danger btn-sm mx-1" ><i class="fas fa-trash"></i></a></td>
                                                @empty
