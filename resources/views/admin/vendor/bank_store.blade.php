      ...
      <div class="row d-flex justify-content-center">
         <div class="col-md-10">
            <div class="card card-primary">
               ...
               <form class="form-horizontal add-bank-details-form" action="{{ route('admin.vendor.bank-details.add') }}" method="POST" autocomplete="off">
                 @csrf
                     <div class="card-body">
                         <input type="hidden" name="id" value="{{ $bankDetails->id ?? 0 }}">
                         <input type="hidden" name="vendor_id" value="{{ $vendorId ?? 0 }}">
