        ...
        <div class="col-sm-6">
            ...
            <div class="col-sm-6">
               <ol class="breadcrumb float-sm-right">
                  ...
                  <li class="breadcrumb-item active">Perfoma Invoice Details</li>
               </ol>
            </div>
      </div>
    </div><!-- /.container-fluid -->
          ...
          <div class="invoice p-3 mb-3">
            ...
            <div class="row">
              ...
              <div class="col-6">
                ...
                <p>Bank Name : {{$dataArr['invoice']->bank_account->bank_name}}<br>
                Account Number : {{$dataArr['invoice']->bank_account->account_no}}<br>
                Branch : {{$dataArr['invoice']->bank_account->branch_name}}<br>
                IFSC : {{$dataArr['invoice']->bank_account->ifsc_code}}<br></p>
                @endif
                <p><b>Declartion:</b></p>
