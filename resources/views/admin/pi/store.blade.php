   ...
   <section class="content-header">
      <div class="container-fluid">
         <div class="row mb-2">
            <div class="col-sm-6">
               <h1>
                  Perfoma Invoice {{ isset($dataArr) ? "Edit" : "Add" }}
               </h1>
            </div>
            <div class="col-sm-6">
               <ol class="breadcrumb float-sm-right">
                  <li class="breadcrumb-item"><a href="{{ route('admin.index') }}">Home</a></li>
                  <li class="breadcrumb-item"><a href="{{ route('admin.perfoma-invoice') }}">Perfoma Invoice</a> </li>
                  <li class="breadcrumb-item active">Perfoma Invoice {{ isset($dataArr) ? "Edit" : "Add" }}</li>
               </ol>
            </div>
         </div>
      </div><!-- /.container-fluid -->
         ...
         <div class="col-md-10">
            <div class="card card-primary">
               <div class="card-header">
                  <h3 class="card-title">Perfoma Invoice</h3>
               </div>
               <div class="card-body">
                  <form class="add-pi-form" action="{{ route('admin.perfoma-invoice.store') }}" method="POST">
                     @csrf
                     @method("POST")
                     ...
                     <div id="production">
                        @if(isset($dataArr['pi_items']) && !empty($dataArr['pi_items']))
                           @foreach($dataArr['pi_items'] as $key => $pi)
                              <div class="row">
...
<script src="{{ asset('js/pages/pi/add_pi.js') }}"></script>
