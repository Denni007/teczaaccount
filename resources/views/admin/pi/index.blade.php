...
@section('title') Perfoma Invoice @endsection
@section('page-header')
@php
...
@section('content')
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Perfoma Invoice </h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="{{ route('admin.index') }}">Home</a></li>
                        <li class="breadcrumb-item active">Perfoma Invoice </li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
    ...
    <div class="card m-2">
        ...
        @if(empty($permissions))
            <a href="{{ route('admin.perfoma-invoice.add') }}" class="btn btn-primary float-right"> Add Perfoma Invoice</a>
...
<script>
    const delete_url = "{{ route('admin.perfoma-invoice.delete') }}";
    const approve_url = "{{ route('admin.perfoma-invoice.approve') }}";
    const reject_url = "{{ route('admin.perfoma-invoice.reject') }}";
    ...
    $(document).ready( function () {
        companyTable = $('#datatable').DataTable({
            ...
            bSort:false,
            ajax: {
                url: "{{ route('admin.perfoma-invoice.filter') }}",
                type: 'POST',
                headers: {
        ...
        $(document).on('click','.pi-delete', function() {
        var id= $(this).data('id');
        ...
        $(document).on('click','.pi-approve', function() {
        var id= $(this).data('id');
        var companyTable_row = $(this).closest("tr");
        Swal.fire({
            title: 'Are you sure?',
            text: "You want to approve this perfoma invoice ?",
             type: 'warning',
            //icon: 'warning',
            showCancelButton: true,
        ...
        $(document).on('click','.pi-reject', function() {
        var id= $(this).data('id');
        var companyTable_row = $(this).closest("tr");
        Swal.fire({
            title: 'Are you sure?',
