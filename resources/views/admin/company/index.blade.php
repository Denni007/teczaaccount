...
@section('content')
    ...
    <div class="card m-2">
        <div class="card-header header-elements-inline">
            <h5>Company List</h5>
            <a href="{{ route('admin.company.add') }}" class="btn btn-primary float-right"> Add Company</a>
        </div>
        <div class="card-body">
            <div class="row">
...
<script>
    const delete_url = "{{ route('admin.company.delete') }}";
    ...
    $(document).ready( function () {
        companyTable = $('#datatable').DataTable({
            ...
            bSort:false,
            ajax: {
                url: "{{ route('admin.company.filter') }}",
                type: 'POST',
                headers: {
            ...
            columns: [
                ...
                { data: 'company_name', name: 'company_name',className: 'text-center1', searchable:false, orderable:false},
