            ...
            <tr>
                <td style="width: 60%; border-right: 1px solid #000;  padding: 0; vertical-align: top;">
                    <table style="width:100%; border-collapse: collapse; ">
                        ...
                        <tr>
                            <td colspan="2" style=" font-size: 16px; line-height: 1.3; color: #000; padding: 10px 8px 0px 8px;">Buyer</td>
                        </tr>
                        <tr>
                    ...
                    <table style="width:100%; border-collapse: collapse; ">
                        ...
                        @php $count = 0;$taxper=0;$totQty =0; @endphp
                            @foreach($dataArr['items'] as $key => $item)
                                <tr>
                                    <td style="width: 6%; text-align: center; font-size: 16px; font-weight: 600; padding:10px 8px 10px 8px; border-right: 1px solid #000;">{{$key+1}}</td>
                                    <td style="width: 39%; text-align: left; font-size: 16px; font-weight: 600; padding:10px 8px 10px 8px; border-right: 1px solid #000;">{{$item->product->product_name}}</td>
                        ...
                        <tr>
                            ...
                            <td style="width: 50%;  padding: 0; vertical-align: top;">
                                <table style="width:100%; border-collapse: collapse; ">
                                    ...
                                    <tr>
                                        <td style="width: 30%; font-size: 16px; padding:10px 8px 0px 8px;">Bank Name :</td>
                                        <td style="width: 70%; font-size: 16px; text-align: left; padding:10px 8px 0px 8px; font-weight: bold;">{{$dataArr['invoice']->bank_account->bank_name}}</td>
                                    </tr>
                                    <tr>
                                        <td style="width: 30%; font-size: 16px; padding:10px 8px 0px 8px;">A/c No. :</td>
                                        <td style="width: 70%; font-size: 16px; text-align: left; padding:10px 8px 0px 8px; font-weight: bold;">{{$dataArr['invoice']->bank_account->account_no}}</td>
                                    </tr>
                                    <tr>
                                        <td style="width: 30%; font-size: 16px; padding:10px 8px 0px 8px; vertical-align: top;">Branch & IFS Code :</td>
                                        <td style="width: 70%; font-size: 16px; text-align: left; padding:10px 8px 0px 8px; font-weight: bold;">{{$dataArr['invoice']->bank_account->branch_name}} & {{$dataArr['invoice']->bank_account->ifsc_code}}</td>
                                    </tr>
                                </table>
                            </td>
                        </tr>
