...
@section('content')
    ...
    <div class="card m-2">
        ...
        ?>   
            ...
            <a href="{{ route('admin.product.add') }}" class="btn btn-primary float-right"> Add Product</a>
...
<script>
    const delete_url = "{{ route('admin.product.delete') }}";
    ...
    $(document).ready( function () {
        companyTable = $('#datatable').DataTable({
            ...
            columns: [
                ...
                { data: 'product_type', name: 'product_type',className: 'text-center1',searchable:false , orderable:false},
